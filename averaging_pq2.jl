...
for (i, U) in enumerate(U_list)
    local file = "./tarek_data/asymm/test_Pq2_Lx4_Ly4_LA4_N25_U$(U)_beta18.0_seed1234.jld"
...
# jldopen("./tarek_data/asymm/processed/denom_2_Pq2_Lx4_Ly4_LA4_N25_beta18.0.jld", "w") do file
#     write(file, "U", U_list)
